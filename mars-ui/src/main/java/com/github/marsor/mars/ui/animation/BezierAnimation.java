package com.github.marsor.mars.ui.animation;
...
import com.github.marsor.mars.ui.dimen.ScreenUtils;
...
public final class BezierAnimation {
    ...
    public static void addCart(MarsDelegate delegate, View start, View end,
