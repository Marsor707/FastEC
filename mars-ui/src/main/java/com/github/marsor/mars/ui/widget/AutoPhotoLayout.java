...
public class AutoPhotoLayout extends LinearLayoutCompat {
    ...
    public final void setDelegate(MarsDelegate delegate) {
                ...
                if (window != null) {
                    ...
                    window.findViewById(R.id.dialog_image_clicked_btn_delete)
                            .setOnClickListener(new OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    //得到要删除的图片
                                    final AppCompatImageView deleteImage =
                                    ...
                                    deleteImage.setAnimation(animation);
                                    animation.start();
                                    AutoPhotoLayout.this.removeView(deleteImage);
                                    mCurrentNum--;
